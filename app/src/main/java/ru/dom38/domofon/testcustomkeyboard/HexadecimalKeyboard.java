...
public class HexadecimalKeyboard {
    ...
    private KeyboardView.OnKeyboardActionListener mOnKeyboardActionListener = new KeyboardView.OnKeyboardActionListener() {
        ...
        public void onKey(int primaryCode, int[] keyCodes) {
            ...
            Log.d("KB", "In: " + primaryCode);

            View focusCurrent = mHostActivity.getWindow().getCurrentFocus();

            if (focusCurrent == null || focusCurrent.getClass() != AppCompatEditText.class) {
                Log.d("KB", "class: " + (focusCurrent == null ? "null" : (AppCompatEditText.class.toString() + " !=" + focusCurrent.getClass().toString())));
                return;
            }
            ...
            switch (primaryCode) {
                ...
                //    }
                default:
                    Log.d("KB", "In: " + Character.toString((char) primaryCode));
...
//        mKeyboardView = (KeyboardView) mHostActivity.getLayoutInflater().inflate(R.xml.keyboard, null);
        //FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, FrameLayout.LayoutParams.WRAP_CONTENT);
        //params.gravity = Gravity.CENTER_HORIZONTAL | Gravity.BOTTOM;

        //mHostActivity.addContentView(mKeyboardView, params);

        mKeyboardView.setKeyboard(new Keyboard(mHostActivity, R.layout.hexadecimal_keyboard));
